...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2022/10/13 21:04:07 by ggneme            #+#    #+#              #
#    Updated: 2022/10/27 14:16:31 by ggneme           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_BONUS =	ft_lstadd_front_bonus.c		ft_lstdelone_bonus.c		ft_lstlast_bonus.c	\
